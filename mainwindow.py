...
class Ui_MainWindow(object):
        ...
        if temp != '':
            try:
                ...
                if foundStatus == True:
                    ...
                    print(str(time.strftime("%H:%M : ", time.localtime())) +'Can not find number in table.')
            ...
            self.openDialog('ไม่สามารถค้นข้อมูลว่างได้')
    ...
    def openDialog(self,message):
        ...
        msg.setText(message + str(time.strftime(" @ %H:%M", time.localtime())))
        msg.exec_()
    ...
    def setupUi(self, MainWindow):
        ...
        self.btn_load.setStyleSheet('background-color: blue')
        ...
        self.btn_load.clicked.connect(self.searchData)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_load.setText(_translate("MainWindow", "SEARCH"))
